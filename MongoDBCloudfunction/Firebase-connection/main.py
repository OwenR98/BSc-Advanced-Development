...
mongoClient = pymongo.MongoClient("mongodb+srv://Owen:Owen@adlabcluster.ypwbz.mongodb.net/myFirstDatabase?retryWrites=true&w=majority") 
...
def store_post_mongodb(title, author, content, dateCreated, thumbnail): 
    ...
    json_data = {"title": title, "author": author, "dateCreated": dateCreated, "thumbnail": thumbnail, "content": content}
...
def forum_cloudfunc(): 
    url = "https://europe-west2-adlab-10-2021.cloudfunctions.net/mongodbdisplay" 
